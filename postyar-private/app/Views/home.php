...
<body class="bg-[#0D0B08] text-neutral-100 antialiased selection:bg-indigo-500 selection:text-white">
            ...
            <div class="glass-light rounded-2xl px-6 py-3.5 flex items-center justify-between">
                ...
                <a href="#" class="flex items-center gap-3 group">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 p-0.5 shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-transform">
                        <div class="w-full h-full bg-[#0D0B08] rounded-[10px] flex items-center justify-center overflow-hidden">
    ...
    <!-- ===== MOBILE MENU DRAWER ===== -->
    <div id="mobileMenu" class="fixed inset-0 z-50 bg-[#0D0B08]/95 backdrop-blur-xl hidden flex-col justify-between p-6 md:hidden">
        <div>
                ...
                <div class="lg:col-span-5 relative reveal reveal-delay-2">
                    <div class="relative">
                        ...
                        <div style="text-align:center; margin-bottom:1rem;">
                            <img src="<?php echo \WHCM\Core\Bootstrap::getAssetsUrl(); ?>/images/asovin.webp" alt="آسوین - پُست‌یار" style="height:200px; width:auto; filter:drop-shadow(0 12px 32px rgba(217,160,54,0.35));" class="mx-auto lg:mx-0">
                        </div>

                        <div class="glass-light rounded-3xl p-5 sm:p-6 float-animation shadow-2xl">
                            <div class="bg-[#1B1712] rounded-2xl p-5 space-y-4 border border-neutral-800/80">
    ...
    <section class="relative py-14 border-y border-neutral-800/60 overflow-hidden bg-[#14110D]">
    ...
    <!-- ===== 4. STATS BANNER ===== -->
    <section class="relative py-20 border-y border-neutral-800/60 bg-[#14110D]">
    ...
    <section id="comparison" class="relative py-24 md:py-32 bg-[#14110D]">
                    ...
                    <thead>
                        <tr class="bg-gradient-to-l from-indigo-600/90 to-purple-600/90 text-white">
                            ...
                            <th class="py-4 px-5 font-bold text-base text-white text-center" style="border-radius: 12px 0 0 0;">
                                <span class="inline-flex items-center gap-2">
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" fill="#F98E3F"/><path d="M12 6v6l4 2" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
                                    بله
                                </span>
                            </th>
                        </tr>
                        ...
                        <div class="plan-card <?php echo $is_featured ? 'featured-plan' : ($p['price'] > 500000 ? 'recommended' : ''); ?>">
                            <div>
                                <?php if (!empty($p['image_url']) && $p['image_url'] !== 'null'): ?>
                                    <div class="plan-card-img-wrapper" style="background: linear-gradient(135deg, rgba(217,160,54,0.2) 0%, rgba(23,19,16,0.95) 100%); min-height: 160px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 16px; margin-bottom: 1.25rem; position: relative; border: 1px solid rgba(217,160,54,0.3);">
                                        ...
                                        <div class="fallback-plan-banner" style="display:none; width:100%; height:160px; background: linear-gradient(135deg, #241A0C 0%, #2A180C 50%, #171310 100%); align-items:center; justify-content:center; flex-direction:column; gap:0.5rem; border-radius:16px;">
                                            <span style="font-size:3rem; filter: drop-shadow(0 0 15px rgba(199,126,60,0.8));">💎</span>
                                ...
                                <?php else: ?>
                                    <div class="plan-card-img-wrapper" style="background: linear-gradient(135deg, #241A0C 0%, #2A180C 50%, #171310 100%); min-height: 160px; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 0.5rem; overflow: hidden; border-radius: 16px; margin-bottom: 1.25rem; position: relative; border: 1px solid rgba(199,126,60,0.4); box-shadow: inset 0 0 25px rgba(199,126,60,0.2);">
                                        <span style="font-size:3rem; filter: drop-shadow(0 0 15px rgba(199,126,60,0.8));">💎</span>
                                        <span style="color:#e9d5ff; font-weight:900; font-size:1.05rem; letter-spacing:1px;"><?php echo htmlspecialchars($p['title']); ?></span>
                                        <div class="neon-badges-overlay">
                                            <?php if (!empty($p['discount_badge_text'])): ?>
                                ...
                                <div style="text-align: center; margin-bottom: 0.9rem;">
                                    <?php if ($gen_discount > 0): ?>
                                        <span style="text-decoration: line-through; color: #8A7F72; font-size: 0.88rem; margin-left: 0.35rem;"><?php echo \WHCM\Domain\TextFormat::fa_num($p['price']); ?></span>
                                        <span style="color: #35C47E; font-size: 1.25rem; font-weight: 900;"><?php echo \WHCM\Domain\TextFormat::fa_num($final_price); ?> <span style="font-size: 0.78rem; font-weight: normal; color: #B0A695;">تومان</span></span>
                                    <?php else: ?>
                                        <span style="font-size: 1.25rem; font-weight: 900; color: #ffffff;"><?php echo \WHCM\Domain\TextFormat::fa_num($p['price']); ?> <span style="font-size: 0.78rem; font-weight: normal; color: #B0A695;">تومان</span></span>
                                    <?php endif; ?>
                                </div>
    ...
    <section id="testimonials" class="relative py-24 md:py-32 border-y border-neutral-800/60 bg-[#14110D]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- ===== 9. FINAL CTA SECTION ===== -->
    <section class="relative py-24 md:py-32 overflow-hidden bg-[#0D0B08]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- ===== FOOTER ===== -->
    <footer class="relative pt-16 pb-12 border-t border-neutral-800/60 bg-[#0D0B08]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
