...
<div class="card">
    ...
    <div id="copy-ref-toast" style="display:none; position:fixed; bottom:2rem; left:50%; transform:translateX(-50%); background:#2FB344; color:white; padding:0.75rem 1.5rem; border-radius:12px; font-weight:700; z-index:9999; box-shadow:0 8px 25px rgba(0,0,0,0.4);">
        با موفقیت کپی شد! 📋
    </div>
