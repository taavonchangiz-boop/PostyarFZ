...
<div class="card">
    ...
    <form action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/save-referral-settings'); ?>" method="POST">
        ...
        <!-- پاداش ثبت‌نام -->
        <h3 style="font-size:0.95rem; margin-top:1.5rem; margin-bottom:0.75rem; border-bottom:1px dashed var(--border); padding-bottom:0.4rem; color:#3CCDB2;">🎁 پاداش ثبت‌نام (برای معرف)</h3>
        <div class="form-row" style="margin-bottom:1.5rem;">
            <div class="form-group">
                <label for="reg-reward-type">نوع پاداش:</label>
                <select name="register_reward_type" id="reg-reward-type" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
            ...
            <div class="form-group">
                ...
                <input type="number" name="register_reward_value" id="reg-reward-value" 
                    ...
                    style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
            </div>
        </div>

        <!-- پاداش خرید اول -->
        <h3 style="font-size:0.95rem; margin-top:1.5rem; margin-bottom:0.75rem; border-bottom:1px dashed var(--border); padding-bottom:0.4rem; color:#3CCDB2;">💳 پاداش خرید اول زیرمجموعه (برای معرف)</h3>
        <div class="form-row" style="margin-bottom:1.5rem;">
            <div class="form-group">
                <label for="fp-reward-type">نوع پاداش:</label>
                <select name="first_purchase_reward_type" id="fp-reward-type" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
        ...
        <!-- محدودیت‌ها -->
        <h3 style="font-size:0.95rem; margin-top:1.5rem; margin-bottom:0.75rem; border-bottom:1px dashed var(--border); padding-bottom:0.4rem; color:#3CCDB2;">⚙ محدودیت‌ها و سقف‌ها</h3>
        <div class="form-row" style="margin-bottom:1.5rem;">
            <div class="form-group">
