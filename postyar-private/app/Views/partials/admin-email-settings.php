...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(180px, 1fr)); gap:1rem; margin-bottom:1.5rem;">
    <div class="card-stat" style="background:linear-gradient(135deg, #312e81 0%, #169F85 100%); border-radius:14px; padding:1.25rem; text-align:center;">
    ...
    <div class="card-stat" style="background:linear-gradient(135deg, #7f1d1d 0%, #D63939 100%); border-radius:14px; padding:1.25rem; text-align:center;">
        <div style="font-size:2rem;">❌</div>
    ...
    <div class="card-stat" style="background:linear-gradient(135deg, #DFF6E7 0%, #2FB344 100%); border-radius:14px; padding:1.25rem; text-align:center;">
        <div style="font-size:2rem;">📋</div>
    ...
    <div class="card-stat" style="background:linear-gradient(135deg, #065f46 0%, #28993B 100%); border-radius:14px; padding:1.25rem; text-align:center;">
        <div style="font-size:2rem;">✅</div>
    ...
    <form action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/save-email-config'); ?>" method="POST">
        ...
        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group">
                ...
                <input type="text" name="smtp_host" id="smtp_host" value="<?php echo htmlspecialchars($smtp_host); ?>" placeholder="smtp.example.com" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;">
            </div>
            <div class="form-group">
                <label for="smtp_port">شماره درگاه:</label>
                <input type="number" name="smtp_port" id="smtp_port" value="<?php echo htmlspecialchars($smtp_port); ?>" placeholder="587" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;">
            </div>
        </div>
        ...
        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group">
                ...
                <input type="text" name="smtp_username" id="smtp_username" value="<?php echo htmlspecialchars($smtp_username); ?>" placeholder="user@example.com" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;">
            </div>
            <div class="form-group">
                <label for="smtp_password">رمز عبور:</label>
                <input type="password" name="smtp_password" id="smtp_password" value="" placeholder="<?php echo !empty($smtp_password) ? 'رمز فعلی ذخیره شده است — برای تغییر مقدار جدید وارد کنید' : 'رمز عبور سرور ایمیل'; ?>" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;">
        ...
        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group">
                ...
                <select name="smtp_encryption" id="smtp_encryption" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="smtp_from_name" id="smtp_from_name" value="<?php echo htmlspecialchars($smtp_from_name); ?>" placeholder="پُست‌یار" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
            </div>
        </div>

        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group"><label for="smtp_timeout">زمان انتظار (ثانیه):</label><input type="number" min="5" max="60" name="smtp_timeout" id="smtp_timeout" value="<?php echo htmlspecialchars($smtp_timeout); ?>" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;"></div>
        ...
        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group"><label for="smtp_reply_to">پاسخ به:</label><input type="email" name="smtp_reply_to" id="smtp_reply_to" value="<?php echo htmlspecialchars($smtp_reply_to); ?>" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;"></div>
            <div class="form-group"><label for="smtp_reply_name">نام پاسخ به:</label><input type="text" name="smtp_reply_name" id="smtp_reply_name" value="<?php echo htmlspecialchars($smtp_reply_name); ?>" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;"></div>
        </div>
        <div class="form-group" style="margin-bottom:1.5rem;">
            <label for="smtp_from_address">آدرس ایمیل فرستنده:</label>
            <input type="email" name="smtp_from_address" id="smtp_from_address" value="<?php echo htmlspecialchars($smtp_from_address); ?>" placeholder="noreply@your-domain.ir" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left;">
        </div>

        <div style="display:flex; gap:.75rem; flex-wrap:wrap;">
            <button type="submit" class="btn btn-success" style="flex:1;min-width:180px;">ذخیره تنظیمات ایمیل ✔</button>
            <button type="submit" formaction="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/test-email'); ?>" class="btn" style="flex:1;min-width:180px;background:#055CB4;color:#fff;border:0;border-radius:10px;font-weight:800;">آزمون اتصال و ارسال</button>
        </div>
    </form>
...
<div class="card" style="margin-bottom:1.5rem;">
    ...
    <p style="color:var(--text-muted); font-size:0.85rem; line-height:1.7; margin-bottom:1rem;">
        مدیریت قالب‌های ایمیل برای رویدادهای مختلف سیستم. متغیرها با سینتکس <code style="background:rgba(26,187,156,0.15); color:#128771; padding:0.15rem 0.4rem; border-radius:4px; font-size:0.8rem;">{{name}}</code> جایگزین می‌شوند.
    </p>
            ...
            <tbody>
                ...
                <tr id="email-tpl-row-<?php echo ($t['id'] ?? 0); ?>">
                    <td data-label="کلید رویداد">
                        <code style="background:rgba(26,187,156,0.15); color:#128771; padding:0.2rem 0.5rem; border-radius:6px; font-size:0.8rem; direction:ltr; display:inline-block;"><?php echo htmlspecialchars(($t['event_key'] ?? '')); ?></code>
                    </td>
                    <td data-label="نام قالب" style="color:white; font-weight:600;"><?php echo htmlspecialchars(($t['template_name'] ?? '')); ?></td>
                    <td data-label="موضوع" style="font-size:0.82rem; color:#626D7D; max-width:200px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo htmlspecialchars(($t['subject'] ?? '')); ?>"><?php echo htmlspecialchars(($t['subject'] ?? '')); ?></td>
                    <td data-label="وضعیت">
    ...
    <div style="margin-top:1.25rem; padding-top:1.25rem; border-top:1px dashed var(--border);">
        ...
        <form id="email-template-form" action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/save-email-template'); ?>" method="POST">
            ...
            <div class="form-row" style="margin-bottom:1rem;">
                <div class="form-group">
                    ...
                    <select name="event_key" id="email_event_key" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="template_name" id="email_tpl_name" placeholder="مثال: خوش‌آمدگویی" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
                </div>
            </div>

            <div class="form-group" style="margin-bottom:1rem;">
                <label for="email_tpl_subject">موضوع ایمیل:</label>
                <input type="text" name="subject" id="email_tpl_subject" placeholder="مثال: خوش آمدید {{name}} عزیز!" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
            </div>

            <div class="form-group" style="margin-bottom:1rem;">
                <label for="email_tpl_body">بدنه HTML ایمیل:</label>
                <textarea name="body_html" id="email_tpl_body" rows="12" placeholder="<h1>سلام {{name}} عزیز</h1><p>به {{app_name}} خوش آمدید</p>" style="width:100%; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; padding:0.75rem; font-family:monospace; font-size:0.82rem; direction:ltr; text-align:left;"></textarea>
            </div>

            <div class="form-row" style="margin-bottom:1rem;">
                <div class="form-group">
                    <label for="email_tpl_vars">متغیرها (JSON):</label>
                    <input type="text" name="variables" id="email_tpl_vars" value='[]' placeholder='["name", "app_name"]' style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB; direction:ltr; text-align:left; font-family:monospace; font-size:0.82rem;">
                </div>
            ...
            <div style="display:flex; gap:0.75rem;">
                ...
                <button type="button" class="btn btn-outline" style="background:rgba(26,187,156,0.15); color:#128771; border:1px solid rgba(26,187,156,0.3); padding:0.6rem 1.2rem; border-radius:10px; cursor:pointer; font-weight:700;" onclick="previewCurrentEmailTemplate()">👁 پیش‌نمایش</button>
            </div>
        </form>
        ...
        <div style="margin-top:1rem; background:rgba(26,187,156,0.06); border:1px solid rgba(26,187,156,0.2); border-radius:10px; padding:0.85rem;">
            <h4 style="font-size:0.85rem; color:#128771; margin-bottom:0.5rem;">📘 متغیرهای قابل استفاده:</h4>
            <div style="display:flex; flex-wrap:wrap; gap:0.5rem;">
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{name}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{app_name}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{app_url}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{plan_name}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{amount}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{date}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{days_left}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{ticket_subject}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{reset_link}}</code>
                <code style="background:#F9FAFB; color:#626D7D; padding:0.2rem 0.6rem; border-radius:6px; font-size:0.78rem;">{{message}}</code>
            </div>
        </div>
    </div>
</div>
...
<div class="card" style="margin-bottom:1.5rem;">
    ...
    <form action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/send-bulk-email'); ?>" method="POST" onsubmit="return confirm('آیا از ارسال ایمیل انبوه مطمئن هستید؟ این عمل غیرقابل بازگشت است.');">
        ...
        <div class="form-group" style="margin-bottom:1.25rem;">
            ...
            <select name="recipient_type" id="bulk_email_recipient" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
            ...
            <div style="font-size:0.78rem; color:var(--text-muted); margin-top:0.35rem;">
                تعداد کاربران فعال: <strong style="color:#128771;"><?php echo $tf::fa_digits($recipient_count); ?></strong> نفر
            </div>
        </div>

        <div class="form-group" style="margin-bottom:1.5rem;">
            <label for="bulk_email_template">قالب ایمیل:</label>
            <select name="bulk_template_id" id="bulk_email_template" style="width:100%; padding:0.6rem; border-radius:10px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
...
<div class="card">
    ...
    <form method="GET" action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/email-settings'); ?>" style="display:flex; gap:0.75rem; margin-bottom:1.25rem; align-items:flex-end; flex-wrap:wrap;">
        <div class="form-group" style="flex:1; min-width:150px; margin-bottom:0;">
            ...
            <select name="filter_status" id="email_log_filter_status" style="width:100%; padding:0.5rem; border-radius:8px; background:#F9FAFB; color:white; border:1px solid #E6E7EB;">
        ...
        <a href="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/email-settings'); ?>" class="btn btn-outline" style="background:rgba(30,38,51,0.045); color:var(--text-muted); border:1px solid var(--border); padding:0.5rem 1rem; border-radius:8px; white-space:nowrap; text-decoration:none; margin-bottom:0;">پاک کردن فیلتر</a>
    </form>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ?></td>
                        <td data-label="موضوع" style="font-size:0.82rem; color:#626D7D; max-width:200px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo htmlspecialchars($l['subject'] ?? ''); ?>"><?php echo htmlspecialchars($l['subject'] ?? '—'); ?></td>
                        <td data-label="وضعیت">
                            <?php
...
<div id="email-preview-modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.7); z-index:10000; justify-content:center; align-items:center; padding:2rem;">
    <div style="background:#F9FAFB; border:1px solid #E6E7EB; border-radius:16px; width:100%; max-width:700px; max-height:85vh; overflow:hidden; display:flex; flex-direction:column;">
        <div style="display:flex; justify-content:space-between; align-items:center; padding:1rem 1.25rem; border-bottom:1px solid #E6E7EB;">
            <h3 style="margin:0; color:white; font-size:1rem;">👁 پیش‌نمایش قالب ایمیل</h3>
            <button type="button" onclick="document.getElementById('email-preview-modal').style.display='none'" style="background:none; border:none; color:#626D7D; font-size:1.3rem; cursor:pointer;">✖</button>
        </div>
...
function previewEmailTemplate(tplId) {
    ...
    document.getElementById('email-preview-content').innerHTML = '<div style="text-align:center; padding:2rem; color:#AEB6C0;">در حال بارگذاری...</div>';
    ...
    fetch('<?php echo \WHCM\Core\Bootstrap::getRouteUrl("/hnnh/preview-email-template"); ?>', {
        ...
        document.getElementById('email-preview-content').innerHTML = '<div style="text-align:center; padding:2rem; color:#D63939;">خطا در بارگذاری پیش‌نمایش</div>';
    });
}
