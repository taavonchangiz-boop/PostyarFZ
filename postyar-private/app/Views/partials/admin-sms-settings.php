...
<div class="card" style="margin-bottom:1.5rem;">
    ...
    <form action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/save-sms-config'); ?>" method="POST">
        ...
        <div class="form-group" style="max-width:520px;margin-bottom:1.25rem;">
            ...
            <select name="sms_provider_active" id="sms_provider_active" style="width:100%;padding:.75rem;border-radius:10px;background:#141D2B;color:#fff;border:1px solid #2E3B55;">
        ...
        ?>
            <section class="sms-provider-card" data-provider="<?php echo htmlspecialchars($id); ?>" style="display:none;border:1px solid #26324A;border-radius:14px;padding:1.25rem;background:#141D2B;margin-bottom:1rem;">
        ...
        <div id="sms-test-phone" style="display:none;margin-top:1rem;border:1px dashed #2E3B55;border-radius:12px;padding:1rem;">
            <label for="test_phone">شماره موبایل برای آزمون ارسال:</label>
            <input type="text" name="test_phone" id="test_phone" placeholder="۰۹۱۲۳۴۵۶۷۸۹" style="width:100%;max-width:360px;padding:.65rem;border-radius:10px;background:#141D2B;color:#fff;border:1px solid #2E3B55;direction:ltr;text-align:left;margin-top:.4rem;">
            <p style="font-size:.75rem;color:#B3BCCB;margin:.5rem 0 0;">برای پنل «اس‌ام‌اس.آی‌آر» آزمون می‌تواند یک پیام واقعی آزمایشی ارسال کند.</p>
        </div>
    </form>
</div>
            ...
            <tbody>
                ...
                <tr>
                    <td data-label="کلید رویداد">
                        <code style="background:rgba(26,187,156,0.15); color:#3CCDB2; padding:0.2rem 0.5rem; border-radius:6px; font-size:0.8rem; direction:ltr; display:inline-block;"><?php echo htmlspecialchars((string)($t['event_key'] ?? '')); ?></code>
                    </td>
        ...
        <form id="sms-template-form" action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/save-sms-template'); ?>" method="POST">
            ...
            <div class="form-row" style="margin-bottom:1rem;">
                <div class="form-group">
                    ...
                    <select name="event_key" id="sms_event_key" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="template_name" id="sms_tpl_name" placeholder="مثال: تایید پرداخت" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
                </div>
            </div>
            <div class="form-row" style="margin-bottom:1rem;">
                <div class="form-group">
                    <label for="sms_tpl_id">شناسه قالب (TemplateId):</label>
                    <input type="number" name="template_id" id="sms_tpl_id" placeholder="مثال: 78432" min="1" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A; direction:ltr; text-align:left;">
                </div>
                <div class="form-group">
                    <label for="sms_tpl_params">پارامترها (JSON):</label>
                    <input type="text" name="parameters" id="sms_tpl_params" value='[]' placeholder='["name", "amount"]' style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A; direction:ltr; text-align:left; font-family:monospace;">
                </div>
            </div>
...
<div class="card" style="margin-bottom:1.5rem;">
    ...
    <form action="<?php echo \WHCM\Core\Bootstrap::getRouteUrl('/hnnh/send-bulk-sms'); ?>" method="POST">
        ...
        <div class="form-group" style="margin-bottom:1.25rem;">
            ...
            <select name="recipient_type" id="bulk_recipient_type" onchange="toggleBulkPhoneInput()" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
            ...
            <div style="font-size:0.78rem; color:var(--text-muted); margin-top:0.35rem;">
                تعداد کاربران فعال دارای شماره: <strong style="color:#3CCDB2;"><?php echo $tf::fa_digits($recipient_count); ?></strong> نفر
            </div>
        </div>
        ...
        <div class="form-group" id="bulk_manual_phones_group" style="margin-bottom:1.25rem; display:none;">
            ...
            <textarea name="manual_phones" id="bulk_manual_phones" rows="3" placeholder="09123456789&#10;09129876543" style="width:100%; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A; padding:0.75rem; direction:ltr; text-align:left; font-family:monospace;"></textarea>
        </div>

        <div class="form-group" style="margin-bottom:1.25rem;">
            <label for="bulk_template_id">قالب پیامک:</label>
            <select name="bulk_template_id" id="bulk_template_id" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
        ...
        <h3 style="font-size:0.9rem; margin-bottom:0.75rem; border-bottom:1px dashed var(--border); padding-bottom:0.4rem; color:#3CCDB2;">🔧 پارامترهای قالب</h3>
        <div class="form-row" style="margin-bottom:1rem;">
            <div class="form-group">
                <label for="param1_name">نام پارامتر ۱:</label>
                <input type="text" name="param1_name" id="param1_name" placeholder="name" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A; direction:ltr; text-align:left;">
            </div>
            <div class="form-group">
                <label for="param1_value">مقدار پارامتر ۱:</label>
                <input type="text" name="param1_value" id="param1_value" placeholder="علی" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
            </div>
        </div>
        <div class="form-row" style="margin-bottom:1.5rem;">
            <div class="form-group">
                <label for="param2_name">نام پارامتر ۲:</label>
                <input type="text" name="param2_name" id="param2_name" placeholder="amount" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A; direction:ltr; text-align:left;">
            </div>
            <div class="form-group">
                <label for="param2_value">مقدار پارامتر ۲:</label>
                <input type="text" name="param2_value" id="param2_value" placeholder="۳۰۰,۰۰۰" style="width:100%; padding:0.6rem; border-radius:10px; background:#141D2B; color:white; border:1px solid #26324A;">
            </div>
        </div>

        <div style="background:rgba(245,159,0,0.08); border:1px solid rgba(245,159,0,0.25); border-radius:10px; padding:0.75rem; margin-bottom:1.25rem; font-size:0.82rem; color:#F5A93B;">
...
<div class="card">
    ...
    <form method="GET" action="/index.php" style="display:flex; gap:0.75rem; margin-bottom:1.25rem; align-items:flex-end; flex-wrap:wrap;">
        ...
        <div class="form-group" style="flex:1; min-width:150px; margin-bottom:0;">
            ...
            <select name="filter_status" id="log_filter_status" style="width:100%; padding:0.5rem; border-radius:8px; background:#141D2B; color:white; border:1px solid #26324A;">
        ...
        <div class="form-group" style="flex:1; min-width:150px; margin-bottom:0;">
            ...
            <input type="text" name="filter_phone" id="log_filter_phone" value="<?php echo htmlspecialchars($filter_phone ?? ''); ?>" placeholder="0912..." style="width:100%; padding:0.5rem; border-radius:8px; background:#141D2B; color:white; border:1px solid #26324A; direction:ltr; text-align:left;">
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="قالب" style="font-size:0.82rem; color:#3CCDB2;"><?php echo htmlspecialchars($l['template_name'] ?? ($l['event_key'] ?? '—')); ?></td>
                        <td data-label="وضعیت">
                            <?php
                                $st = $l['status'] ?? 'pending';
                                $badge_class = 'pending';
